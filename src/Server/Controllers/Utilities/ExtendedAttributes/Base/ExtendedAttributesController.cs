...
using EPharma.Application.Features.ExtendedAttributes.Commands.Delete;
...
using EPharma.Application.Features.ExtendedAttributes.Queries.GetById;
using EPharma.Domain.Contracts;
using Microsoft.AspNetCore.Mvc;

namespace EPharma.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
