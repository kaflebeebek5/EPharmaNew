...
{
    public partial class AddEditGenderModal
    {
        [Inject] private IGenderManager GenderManager { get; set; }

        [Parameter] public AddEditGenderCommand AddEditGenderModel { get; set; } = new();
        ...
        {
            var response = await GenderManager.SaveAsync(AddEditGenderModel);
