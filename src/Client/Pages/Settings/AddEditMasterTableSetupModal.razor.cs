...
{
    public partial class AddEditMasterTableSetupModal
    {
        [Inject] private IMasterTableSetupManager MasterTableSetupManager { get; set; }

        [Parameter] public AddEditMasterTableSetupCommand AddEditMasterTableSetupModel { get; set; } = new();
        ...
        {
            var response = await MasterTableSetupManager.SaveAsync(AddEditMasterTableSetupModel);
