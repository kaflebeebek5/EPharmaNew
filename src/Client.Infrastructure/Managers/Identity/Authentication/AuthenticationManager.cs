...
using EPharma.Client.Infrastructure.Routes;
using EPharma.Shared.Constants.Storage;
using Microsoft.Extensions.Localization;

namespace EPharma.Client.Infrastructure.Managers.Identity.Authentication
{
    public class AuthenticationManager : IAuthenticationManager
    {
        ...
        public async Task<IResult> Login(TokenRequest model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                ((HrStateProvider)this._authenticationStateProvider).MarkUserAsAuthenticated(model.Username);
        ...
        public async Task<IResult> Logout()
        {
            ...
            ((HrStateProvider)_authenticationStateProvider).MarkUserAsLoggedOut();
