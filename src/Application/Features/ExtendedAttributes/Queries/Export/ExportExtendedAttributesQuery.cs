...
using EPharma.Application.Specifications.ExtendedAttribute;
using EPharma.Domain.Contracts;
using EPharma.Domain.Enums;
using EPharma.Shared.Wrapper;
using MediatR;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Localization;

namespace EPharma.Application.Features.ExtendedAttributes.Queries.Export
{
