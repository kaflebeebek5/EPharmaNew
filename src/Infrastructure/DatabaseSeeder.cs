...
using EPharma.Shared.Constants.User;
...
namespace EPharma.Infrastructure
{
    public class DatabaseSeeder : IDatabaseSeeder
    {
        ...
        private void AddAdministrator()
        {
            Task.Run(async () =>
            {
                ...
                var adminRole = new HrRole(RoleConstants.AdministratorRole, _localizer["Administrator role with full permissions"]);
                ...
                var superUser = new HrUser
                {
                    FirstName = "admin",
                    LastName = "admin",
                    Email = "admin@uratech.com",
                    UserName = "admin",
                    EmailConfirmed = true,
