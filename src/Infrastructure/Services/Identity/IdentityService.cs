...
namespace EPharma.Infrastructure.Services.Identity
{
    public class IdentityService : ITokenService
    {
        ...
        public IdentityService(
            ...
            IOptions<AppConfiguration> appConfig, SignInManager<HrUser> signInManager,
        ...
        private async Task<string> GenerateJwtAsync(HrUser user)
        {
            var token = GenerateEncryptedToken(GetSigningCredentials(), await GetClaimsAsync(user));
            return token;
        }

        private async Task<IEnumerable<Claim>> GetClaimsAsync(HrUser user)
        {
