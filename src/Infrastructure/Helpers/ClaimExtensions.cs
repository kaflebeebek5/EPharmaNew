...
namespace EPharma.Infrastructure.Helpers
{
    public static class ClaimsHelper
    {
        ...
        public static async Task<IdentityResult> AddPermissionClaim(this RoleManager<HrRole> roleManager, HrRole role, string permission)
        {
