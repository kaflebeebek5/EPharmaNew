using EPharma.Application.Enums;
...
{
    public abstract class AuditableContext : IdentityDbContext<HrUser, HrRole, string, IdentityUserClaim<string>, IdentityUserRole<string>, IdentityUserLogin<string>, HrRoleClaim, IdentityUserToken<string>>
    {
